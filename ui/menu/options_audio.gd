...
@onready var slider_music_volume_: HSlider = %SliderMusicVolume
@onready var slider_sound_volume_: HSlider = %SliderSoundVolume
...
func _on_button_reset_defaults_pressed() -> void:
	...
	slider_music_volume_.value = 1.0
	slider_sound_volume_.value = 1.0
